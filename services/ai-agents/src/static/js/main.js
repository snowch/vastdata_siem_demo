// UPDATED: src/static/js/main.js - ENHANCED CONTEXT DATA DISPLAY
// Show complete technical details during approval decisions
...
class SOCDashboard {
    ...
    async initialize() {
        console.log('🚀 Initializing SOC Dashboard - Enhanced Context Details in Agent Outputs');
    ...
    // ============================================================================
    // USER ACTIONS - Add view mode toggle
    // ============================================================================
    ...
    async startAnalysis() {
        ...
        console.log(`🚀 Starting analysis in ${this.viewMode} mode with enhanced details in agent outputs`);
    ...
    onTriageResults(data) {
        console.log(`✅ Triage results received - showing ${this.viewMode} details`);
        ...
        this.uiManager.updateProgress(30, 'Triage complete - review details and approve');
    }

    onContextResults(data) {
        console.log(`✅ Context results received - showing ${this.viewMode} details`);
        console.log('🔍 Raw context data:', data.data); // Enhanced debugging
        ...
        this.uiManager.updateProgress(60, 'Context complete - review findings and approve');
    }

    onAnalystResults(data) {
        console.log(`✅ Analyst results received - showing ${this.viewMode} details`);
        ...
        this.uiManager.updateProgress(90, 'Analysis complete - review recommendations and authorize');
    }
    ...
    onWorkflowComplete(data) {
        ...
        console.log('🎯 All approvals complete - showing consolidated findings panel');
...
console.log(`
🔧 DEBUG: Enhanced Context Output Applied
- Context data now shows comprehensive details even when some fields are missing
- Enhanced debugging logs to identify missing data fields
- Fallback content provided for empty sections
- All available context information will be displayed in analyst view
`);